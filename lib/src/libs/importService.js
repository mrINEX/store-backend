...
var create = function () { return __awaiter(void 0, void 0, void 0, function () {
    var command, Buckets, _i, Buckets_1, Bucket, results, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4, ddbClient_1.s3Client.send(new client_s3_1.CreateBucketCommand({ Bucket: bucket }))];
            case 2:
                _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, (0, s3_request_presigner_1.getSignedUrl)(ddbClient_1.s3Client, command, { expiresIn: 15 * 60 })];
                case 1:
                    url = _a.sent();
