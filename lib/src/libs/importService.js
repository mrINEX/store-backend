...
exports.generateGetSignedUrl = exports.generatePutSignedUrl = void 0;
...
var create = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                _a.sent();
                console.log("Bucket '".concat(bucket, "' successfully set CORS"));
            ...
            case 4:
                _a.sent();
                console.log("Bucket '".concat(bucket, "' successfully put"));
                return [3, 6];
            case 5:
                err_1 = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    config = {
                        Bucket: bucket,
                        Key: "".concat(key).concat(fileName)
                    };
